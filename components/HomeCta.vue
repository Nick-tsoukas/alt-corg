<template>
  <div class="main_container">
    <div class="container mx-auto cta_home_container">
      <div class="cta_intro_top">
        <h1 class="support_text">SUPPORT CRS</h1>
        <h1 class="cta_intro_header">HOW YOU CAN HELP</h1>
    ...
    <div class="content_grid">
      ...
      <div class="cta_item">
        <div>
          <img class="cta_icon" src="../static/dollar.svg" alt="">
        </div>
        <div>
          <h1 class="cta_item_heading">DONTATE</h1>
        </div>
        <div>
          <p class="cta_content">The Corgwyn Rehabilitation Sanctuary runs completely on donations. Your donations help cover food, vet
            bills, and other key expenses</p>
        </div>
	...
	C485.3,249.9,486.2,274.6,472.1,293.7z" />
        ...
        <div>
          <h1 class="cta_item_heading">SPONSOR</h1>
        </div>
        <div>
          <p class="cta_content">Help CRS provide food, veterinary care, and all of the essentials for one of CRS' corgis with a monthly or
            yearly sponsorship</p>
        </div>
        <div class="button_container">
          <button class="meet_button">SPONSOR A CORGI</button>
        </div>
      </div>
      <div class="cta_item">
        <div>
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 259.669 259.669" style="enable-background:new 0 0 259.669 259.669;" xml:space="preserve">
<g>
...
<g>
        ...
        <div>
          <h1 class="cta_item_heading">SUPPORT</h1>
        </div>
        <div>
          <p class="cta_content">Want to help CRS by contributing to our ongoing, recurring costs? Help cover monthly expenses or donate
            from our Amazon wishlist</p>
        </div>
        <div class="button_container">
          <button class="meet_button">SUPPORT CRS </button>
        </div>
      </div>
    </div>
  </div>
